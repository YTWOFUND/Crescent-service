...
Let's set variables:
```
SNAP_RPC="http://crescent-rpc.ytwofund.pro:26687"
...
You can also use an alternative method and use the [Snapshot](https://github.com/YTWOFUND/Crescent-service/blob/main/Snapshot.md#-snapshot-user-guide-).
